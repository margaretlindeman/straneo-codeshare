...
load XSERMILIK_2023_raw.mat
XCTDlat = XPDlat;
XCTDlon = XPDlon;
XCTDtime = XPDtime+365;%time off by a year in the mat file
...
outfile = 'Sermilik2023_XCTD.nc' 
delete(outfile)
instrument = 'Sippican XCTD-1 probes';
summary = 'Temperature and salinity profiles from 12 eXpendable Conductivity Temperature Depth (XCTD) 1 probes collected in Sermilik Fjord, East Greenland, during July 2023.';
title = 'XCTD profiles of temperature and salinity from Sermilik Fjord during July 2023';
...
% global attributes 
    ...
    netcdf.putAtt(ncid,varid,'contributor_name','Fiamma Straneo, Jamie Holte, Margaret Lindeman, Aurora Roth, Greg Hanlon');
...
lat = XCTDlat;
lon = XCTDlon;
save('Sermilik2023_XCTD.mat','date','depth','lat','lon','pres','sal','temp') 
