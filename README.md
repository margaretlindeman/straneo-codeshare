...
Guide to code uses contained in this repo: 

- XCTD data processing
...
- [Intro to Plume Models](https://github.com/nmcgee108/Intro_to_plume_models) by Natalie McGee
  - Natalie's Python implementation of plume model with in-depth background info
